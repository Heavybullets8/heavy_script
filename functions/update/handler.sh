...
update_handler() {
  ...
  concurrent="${PDATE__concurrent:-$concurrent}"
  timeout="${UPDATE__timeout:-$timeout}"
  prune="${UPDATE__prune:-$prune}"
  rollback="${UPDATE__rollback:-$rollback}"
  sync="${UPDATE__sync:-$sync}"
  stop_before_update="${UPDATE__stop_before_update:-$stop_before_update}"
  update_all_apps="${UPDATE__update_all_apps:-$update_all_apps}"
  verbose="${UPDATE__verbose:-$verbose}"
