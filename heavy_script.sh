    ...
    case $opt in
        ...
        m)
            ...
            if [[ $selection == "1" ]]; then
                ...
                unmount_array=($(basename -a /mnt/temporary/* | sed "s/*//"))
        ...
        t)
            ...
            ;;
        U)
            array=($(cli -m csv -c 'app chart_release query name,update_available,human_version,human_latest_version,status' | grep ,true,))
